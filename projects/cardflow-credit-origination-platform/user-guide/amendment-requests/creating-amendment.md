...
![Creating an Amendment Request Button](../images/amendment-requests/creating-an-amendment-request-button.png) 
*Creating an Amendment Request – Creating an Amendment Request Button*

2.	Click Create Amendment Request
Create Amendment Request screen displays.
 
Figure 20 Creating an Amendment Request – Create Amendment Request Screen
3.	Review the current application information.
4.	Provide a reason for the amendment.

 
Figure 21 Creating an Amendment Request – Reasons for Amendment
