...
Validation errors occur when required information is missing, incomplete, or does not meet configured business rules.
...
| **Resolution** | 1. Review all highlighted fields.<br>2. Enter the required information.<br>3. Save or resubmit the request. |
...
| **Resolution** | 1. Verify the entered value.<br>2. Correct the format.<br>3. Save or resubmit the request. |
...
| **Resolution** | 1.	Review validation messages displayed by the system.<br> 2. Complete the missing requirements.<br> 3. Resubmit the application.
...
**Resolution** | 1.	Verify that the file type is supported.<br>2.	Confirm the file size complies with organizational requirements.<br> 3. Retry the upload.<br> 4. Refresh the page if necessary.
...
**Resolution** | 1.	Refresh the page. <br>2. Verify that the document appears in the Supporting Documents section.<br>3. Re-upload the document if required.
...
**Resolution** | 1.	Open the returned application.<br>2. Review the return  comments.<br>3. Complete the requested updates.<br>4.	Upload any required supporting documents.<br>5.	Resubmit the application.
...
**Resolution** | 1. Review all validation messages. <br> 2.	Complete outstanding requirements. <br> 3. Attempt resubmission again.
...
**Resolution** | 1.	Verify that you are assigned the appropriate role.<br> 2. Contact your administrator if additional permissions are required.
...
**Resolution** | 1.	Verify search filters.<br>2. Confirm application ownership and access permissions.<br> 3. Contact an administrator if necessary.
...
**Resolution** | 1.	Log in again.<br>2.	Navigate back to the required page.<br>3.	Save work regularly to prevent data loss.
