...
**Approval Alert** | Generated when approval actions are required.
**Document Alert** | Generated when document-related actions or updates occur.
...
**Result**: Users can identify the purpose and urgency of each notification.
